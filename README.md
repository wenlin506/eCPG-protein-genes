...
Script2 used data4 file. This script generates individual tissue expression data from the GSE192955 dataset. 
...
You can download and execute the python scripts and required datafiles in the same directory. For example: For running Processing_all_MANE_annotated_genes_from_GSE192955_dataset script; please download “script1.txt” 
Step 1: Save your code to a file
Make sure your Python code is saved in a file ending in .py. For example, save it as script1.py, and place this python file in the exact same folder where the dataset(s) is located.

Step 2: Open your command line tool and navigate to the correct folder
Open your Command Prompt (Windows) or Terminal (Mac/Linux), and use the cd (change directory) command to navigate to the folder where the python script and csv data file located.

Step 3: Run the Script 
Once your command line is pointing to the correct folder, execute the script by typing:
(Windows):
python script1.py
(Mac/Linux): 
python3 script1.py
The output files for this script :
For example, GeneID ENSG00000000457 and gene symbol SCYL3 of chromosome 1, the output xml file for this SCYL3 gene is:
iCPG_chr1_GeneID_ENSG00000000457_SCYL3.xml 
